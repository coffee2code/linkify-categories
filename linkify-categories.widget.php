...
class c2c_LinkifyCategoriesWidget extends WP_Widget {
	...
	public function __construct() {
		$this->title = __( 'Linkify Categories', 'linkify-categories' );
		...
		$widget_ops = array(
			...
			'description' => __( 'Converts a list of categories (by slug or ID) into links to those categories.', 'linkify-categories' ),
		);
